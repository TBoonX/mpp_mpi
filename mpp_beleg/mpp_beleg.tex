...
\end{itemize}
Das Ergebnis der Integration soll $\pi$ sein. Dabei soll das doppeltgenaue Maschinen-$\pi$ als Referenz f\"ur die Genauigkeit der Berechnung dienen.\\

Dies wurde in einem C-Programm umgesetzt. Die Anzahl der Prozessoren, die zu integrierende Funktion und die Anzahl der Zerlegungen des Intervalls sollen dabei
Eingabewerte sein.\\
Als Resultat soll das Laufzeitverhalten und die Genauigkeit der Funktionen stehen.
