...
\subsection{Programmbeschreibung}
Das Programm wird auf dem Rechner Abel im Rechnerpool gestartet, der mit dem Multiprozessorsystem MC-3 verbunden ist. Als Startparameter m\"ussen die Anzahl
der Prozessoren \texttt{p} und die Anzahl der Integrationsintervalle \texttt{n}.
